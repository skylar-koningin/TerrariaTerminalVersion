...
def playerturn
  ...
  sleep(0.5)
  puts "Stardust Pillar has #{$bosshp} HP remaining."
  sleep(0.5)
  ...
  if action == "attack" || action == "a" || action == "1"
    ...
    sleep(0.5)
    if attackamount == 1
      puts "You attack Stardust Pillar with your #{$playerinfo['current_weapon']} #{attackamount} time for #{damage} damage!"
    else
      puts "You attack Stardust Pillar with your #{$playerinfo['current_weapon']} #{attackamount} times for #{damage} damage!"
    end
    $bosshp -= damage
    if $bosshp <= 0
      puts "You have defeated Stardust Pillar!"
...
def bossturn
  system('clear')
  puts "Stardust Pillar's turn"
  bossattack = rand(1..3)
  if bossattack == 1
    sleep(0.5)
    puts "Stardust Pillar launches an attack at you..."
    sleep(2)
...
puts "Stardust Pillar has awoken!"
