...
def playerturn
  ...
  sleep(0.5)
  puts "Empress of Light has #{$bosshp} HP remaining."
  sleep(0.5)
  ...
  if action == "attack" || action == "a" || action == "1"
    ...
    sleep(0.5)
    if attackamount == 1
      puts "You attack Empress of Light with your #{$playerinfo['current_weapon']} #{attackamount} time for #{damage} damage!"
    else
      puts "You attack Empress of Light with your #{$playerinfo['current_weapon']} #{attackamount} times for #{damage} damage!"
    end
    $bosshp -= damage
    if $bosshp <= 0
      puts "You have defeated Empress of Light!"
      $playerinfo['last_boss'] = "empressoflight"
...
def bossturn
  system('clear')
  puts "Empress of Light's turn"
  bossattack = rand(1..3)
  if $bosshp > 35000
    if bossattack == 1
      sleep(0.5)
      puts "Empress of Light launches an attack at you..."
      sleep(2)
...
puts "Empress of Light has awoken!"
